...
public:
    ...
    QPushButton *numbe_caculator_button;
    ...
    void setupUi(QMainWindow *main_windowClass)
    {
        ...
        main_windowClass->resize(433, 639);
        ...
        function_caculator_button->setGeometry(QRect(20, 190, 171, 81));
        ...
        help_function->setGeometry(QRect(160, 300, 171, 81));
        exit_button = new QPushButton(centralWidget);
        exit_button->setObjectName(QStringLiteral("exit_button"));
        exit_button->setEnabled(true);
        exit_button->setGeometry(QRect(220, 450, 171, 81));
        numbe_caculator_button = new QPushButton(centralWidget);
        numbe_caculator_button->setObjectName(QStringLiteral("numbe_caculator_button"));
        numbe_caculator_button->setEnabled(true);
        numbe_caculator_button->setGeometry(QRect(100, 130, 229, 28));
        ...
        matrix_caculator_button->setGeometry(QRect(20, 60, 158, 28));
        ...
        QObject::connect(matrix_caculator_button, SIGNAL(clicked()), main_windowClass, SLOT(use_matrix_caculator()));
        QObject::connect(numbe_caculator_button, SIGNAL(clicked()), main_windowClass, SLOT(use_scientic_caculator()));
        QObject::connect(function_caculator_button, SIGNAL(clicked()), main_windowClass, SLOT(use_function_caculator()));
    ...
    void retranslateUi(QMainWindow *main_windowClass)
    {
        ...
        numbe_caculator_button->setText(QApplication::translate("main_windowClass", "\347\247\221\345\255\246\350\256\241\347\256\227\345\231\250", nullptr));
